        ...
        <div class="col-md-4">
          ...
          @foreach($productImages as $image)
            ...
            @if($lastImgName != $image->imageName)
              ...
              @if($countEverySix == 1)
                <div class="row vert-offset-bottom-1"><br>
              @endif
              ...
              <div class="col-md-2" style="text-align: center;">
                ...
                <a href="http://www.growyourleads.com/uploads/users/id/{{$userId}}/productImages/{{$image->imageName}}" data-lightbox="productImg">
                  ...
                  <img class="lp3PropPrevImgProductImg img-responsive" src="http://www.growyourleads.com/uploads/users/id/{{$userId}}/productImages/{{$image->imageName}}" />
