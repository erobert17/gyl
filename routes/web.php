...
Route::group(['middleware' => 'web'], function() {
    ...
    //digitalfile upload url, used for the jquery fileupload plugin
    Route::post('/digitalFileUpload', ['as' => 'digitalFileUpload', 'uses' => 'LandingPageController@digitalFileUpload']);


    //landing page 8
    Route::get('/link8/{code}', ['as' => 'link', 'uses' => 'LandingPageController@link8']);
    //lp 9
    Route::get('/link9/{code}', ['as' => 'link', 'uses' => 'LandingPageController@link9']);
    ...
    Route::post('/submitEmailDigitalDownload', ['uses' => 'LandingPageController@submitEmailDigitalDownload']);
    // appointments lp8
    Route::post('/submitAppointment', ['uses' => 'LandingPageController@submitAppointment']);

    //lp9 mailing list email signup
    Route::post('/submitEmailLp9', ['uses' => 'LandingPageController@submitEmailLp9']);
...
Route::group(['middleware'=> ['auth', 'activated', 'currentUser']], function () {
    ...
    Route::POST('/updateUserPassword', 'ProfilesController@updateUserPassword');
    ...
    Route::get('edit/landingPage/8', [
        'uses'      => 'LandingPageController@editLandingPage8'
    ]);

    Route::get('edit/landingPage/9', [
        'uses'      => 'LandingPageController@editLandingPage9'
    ]);
    ...
    Route::get('landingPage8Stats', ['uses'      => 'LandingPageController@landingPage8Stats']);

    Route::get('landingPage9Stats', ['uses'      => 'LandingPageController@landingPage9Stats']);
    ...
    Route::post('/uploadBackground8', ['as' => 'uploadBackground8', 'uses' => 'LandingPageController@uploadBackground8']);
    Route::post('/uploadProductImg8', ['as' => 'uploadProductImg9', 'uses' => 'LandingPageController@uploadProductImg8']);

    Route::post('/uploadBackground9', ['as' => 'uploadBackground9', 'uses' => 'LandingPageController@uploadBackground9']);
    Route::post('/uploadProductImg9', ['as' => 'uploadProductImg9', 'uses' => 'LandingPageController@uploadProductImg9']);
    ...
    Route::post('/saveLandingPage8', ['uses' => 'LandingPageController@saveLandingPage8']);
    Route::post('/saveLandingPage9', ['uses' => 'LandingPageController@saveLandingPage9']);
