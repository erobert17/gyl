    <div class="noobMessage noShowOnMobile">
        <div id="paragraphs">
            <p class="text-center">Each landing page has it's own URL you can use to share on social media.</p>
            <p class="text-center">There's a "<strong>Copy</strong>" button below each landing page window.</p>
        </div>
