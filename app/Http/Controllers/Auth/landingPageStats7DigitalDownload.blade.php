                            ...
                            <table class="table table-striped table-condensed data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-sm hidden-xs hidden-md">Email</th>
                                        <th class="hidden-sm hidden-xs hidden-md">Dates</th>
                                ...
                                <tbody>
                                    @foreach($views as $view)
                                        <tr>
                                            ...
                                            <td class="hidden-sm hidden-xs hidden-md">{{$view->email}}</td>
                                            <td class="hidden-sm hidden-xs hidden-md">{{$view->date}}</td>
